...
metallicity and attenuation as additional parameters). Attenuation is
modelled with a one-parameter optical depth and Calzetti (2000) attenuation
curve.
...
9. `dust2`: optical depth of all populations
"""
