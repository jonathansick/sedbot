...
class FiveParamSFHFixedD(object):
    """Model for tau+const+t0+burst (variable time and burst fraction) SFH,
    single Z, and two component dust with fixed distance.

    FIXME: Refactor this class with ThreeParamSFHFixedD (baseclass).
    ...
    """
    _param_names = ('logmass', 'logZZsol', 'sf_start', 'logtau', 'const',
                    'fburst', 'tburst', 'dust1', 'dust2')

    def __init__(self, sed, sed_err, sed_bands, instruments, area, d, priors,
                 pixel_metadata=None,
                 computed_bands=None,
                 pset=None):
        super(FiveParamSFHFixedD, self).__init__()
        self._sed = sed
        self._err = sed_err
        self._area = area
        self.pixel_metadata = pixel_metadata
